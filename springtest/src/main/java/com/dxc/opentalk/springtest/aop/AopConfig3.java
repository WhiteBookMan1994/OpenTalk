...
public class AopConfig3 {
    ...
    public void before()  {
        System.out.println("AopConfig3 before advice begin ...");
    }

    @Around("execution (* com.dxc.opentalk.springtest.service.TestService.*())")
    public void around(ProceedingJoinPoint joinPoint) throws Throwable {
        System.out.println("AopConfig3 around advice begin ...");
        joinPoint.proceed();
        System.out.println("AopConfig3 around advice end ...");
    }

    @After("execution (* com.dxc.opentalk.springtest.service.TestService.*())")
    public void after()  {
        System.out.println("AopConfig3 after advice begin ...");
    }
}
